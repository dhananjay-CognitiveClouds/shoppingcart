     ...
     <div className="searchDiv">
      ...
      <div className="contentDiv">
        ...
        <div className='product_list_div'>
            {
                loading?<img className='loaderImg' src='https://i.pinimg.com/originals/15/f2/09/15f209bdae6da376665c3a1b2cb781ea.gif' alt="img"/> : error? <img className='loaderImg' src='https://cdn.dribbble.com/users/2573223/screenshots/7038977/media/4bf93fe9739caa636cd3d09f79d453b6.gif' alt='img'/> : mappingData.map((item)=>{
                    return (
...
// 'loaderImg' src='https://i.pinimg.com/originals/15/f2/09/15f209bdae6da376665c3a1b2cb781ea.gif'